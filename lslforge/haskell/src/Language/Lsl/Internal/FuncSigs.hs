...
funcDescriptions = [
    ...
    ("llAtan2",(["y","x"],"")),
    ("llAttachToAvatar",(["attach_point"],"Attaches the object to the avatar who has granted permission to the script. The object is taken into the users inventory and attached to attach_point.\n")),
    ...
    ("llFabs",(["val"],"")),
    ("llFleeFrom", (["position","distance","options"], "Directs a character to keep a specific distance from a specific position in the region or adjacent regions.\n")),
    ...
    ("llGetClosestNavPoint", (["point","options"], "Get a point on the navmesh that is the closest point to <i>point</i>.\n")),
    ...
    ("llXorBase64",(["str1","str2"], "Returns a string that is a Base64 XOR of str1 and str2.")),
